            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                    <div class="header-top-right">
                        <p class="pull-left h2-color mtb-10 hidden-sm hidden-xs">Wellcome to Oneclick store! </p>
                ...
                <div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
                    ...
                    <div class="menu-container toggole">
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-mobile"></i> Smartphone & Tablets<i class="fa fa-angle-right pull-right"></i></a></li>
                    ...
                    <div class="mainmenu hover-bg dropdown">
                        <nav>
                            <ul>
                                ...
                                <li><a href="shop.html">Shop <i class="fa fa-caret-down"></i></a>
                                    <div class="megamenu">
												<span>
