                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ $base_url }}/assets/layouts/layout3/img/avatar2.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ $base_url }}/assets/layouts/layout3/img/avatar3.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ $base_url }}/assets/layouts/layout3/img/avatar1.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
        ...
        <div class="page-sidebar-wrapper">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item  ">
                        <a href="{{ url('backend/item.html') }}" class="nav-link nav-toggle">
                            <i class="fa fa-shopping-cart"></i>
                            <span class="title">Product</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/what-news') }}" class="nav-link nav-toggle">
                            <i class="fa fa-space-shuttle"></i>
                            <span class="title">What's News? </span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/brand.html') }}" class="nav-link nav-toggle">
                            <i class="fa fa-sort-amount-asc"></i>
                            <span class="title">Brand</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/item-space.html') }}" class="nav-link nav-toggle">
                            <i class="fa fa-space-shuttle"></i>
                            <span class="title">Space </span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/item-category.html')}}" class="nav-link nav-toggle">
                            <i class="fa fa-navicon"></i>
                            <span class="title">Category</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/web-setting')}}" class="nav-link nav-toggle">
                            <i class="icon-settings"></i>
                            <span class="title">Setting</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/slide.html') }}" class="nav-link nav-toggle">
                            <i class="fa fa-sliders"></i>
                            <span class="title">Slide</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ url('backend/user') }}" class="nav-link nav-toggle">
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                             src="{{ $base_url }}/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
